                    ...
                    <div>
                      ...
                      >
                        ...
                        <SelectContent>
                          ...
                          <SelectItem value="Lighting">Footwear</SelectItem>
                          <SelectItem value="Bags & Accessories">Bags & Accessories</SelectItem>
                          <SelectItem value="Accessories">Accessories</SelectItem>
                          <SelectItem value="Featured Collections (for marketing purposes)">Featured Collections (for marketing purposes)</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    <div>
                        ...
                        <DialogContent className="max-w-2xl animate-scale-in">
                          ...
                          {editingProduct && (
                            <form onSubmit={handleUpdateProduct} className="space-y-4">
                              {/* Similar structure to add form but with edit functionality and image upload */}
                              <div className="grid md:grid-cols-2 gap-4">
                                <div>
